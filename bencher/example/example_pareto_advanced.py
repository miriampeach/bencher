...
if __name__ == "__main__":
    custom_run_cfg = bch.BenchRunCfg()
    custom_run_cfg.repeats = 5  # Multiple repeats to demonstrate randomness effects
    custom_run_cfg.level = 4
    example_pareto_advanced(custom_run_cfg).report.show()
